    ...
    <div className="relative rounded-2xl overflow-hidden shadow-md w-[320px] h-[440px]">
      ...
      <div className="absolute inset-0 p-4 flex flex-col justify-end text-white space-y-3">
        ...
        <div className="flex items-center justify-between">
          <Link
            href={href}
            className="bg-white text-black text-sm rounded-full px-4 py-2 font-medium hover:bg-gray-200 transition"
          >
            Read Recipe →
          </Link>
          <button className="text-white text-xl hover:text-orange-400 transition">
            <IoBookmarkOutline />
          </button>
        </div>
      </div>
